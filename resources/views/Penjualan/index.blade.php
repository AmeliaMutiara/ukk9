                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <input type="date" name="start_date" id="start_date" class="form-control form-control-inline input-medium date-picker input-date" data-date-format="dd-mm-yyyy" type="text" value="{{ $filter['start_date'] ?? date('Y-m-d') }}" style="width: 15rem;" />
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <input type="date" name="end_date" id="end_date" class="form-control form-control-inline input-medium date-picker input-date" data-date-format="dd-mm-yyyy" type="text" value="{{ $filter['end_date'] ?? date('Y-m-d') }}" style="width: 15rem;" />
                                    </div>
                                </div>
                            </div>
                        </div>
