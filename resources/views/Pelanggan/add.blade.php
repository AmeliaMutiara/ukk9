                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input name="namaPelanggan" value="{{ $sessiondata['namaPelanggan'] ?? '' }}" class="form-control" rows="6" placeholder="Masukkan Nama Pelanggan">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label>Nomor Telepon</label>
                            <input name="noTelp" value="{{ $sessiondata['noTelp'] ?? '' }}" class="form-control" rows="6" placeholder="Masukkan Nomor Telepon">
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
